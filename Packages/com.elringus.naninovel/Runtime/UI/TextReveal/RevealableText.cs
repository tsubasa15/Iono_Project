...
namespace Naninovel.UI
{
    ...
    /// </summary>
    [AddComponentMenu("Naninovel/ UI/Revealable Text")]
    public class RevealableText : NaninovelTMProText, IRevealableText
    {
        ...
        protected override bool ContinueTrigger => continueOnClick;
        ...
        [Tooltip("Whether to trigger 'Continue' input when the text is clicked or touched.")]
        [SerializeField] private bool continueOnClick = true;
