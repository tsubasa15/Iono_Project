...
namespace Naninovel
{
        ...
        where TSlot : ScriptableGridSlot
    {
        ...
        [Tooltip("Occurs when grid page number changes.")]
        ...
        public virtual async Awaitable Initialize (int itemsCount)
        {
        ...
        private async Awaitable<TSlot[]> CreateSlots ()
        {
        ...
        private async Awaitable CreateSlot (TSlot[] slots, int idx)
        {
