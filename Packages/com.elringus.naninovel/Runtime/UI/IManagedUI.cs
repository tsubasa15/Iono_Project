...
namespace Naninovel.UI
{
    ...
    {
        /// <summary>
        /// Occurs when the <see cref="Visible"/> of the UI object is changed.
        /// </summary>
        ...
        /// When '*' will never yield the UI from being modal (until it's explicitly removed via <see cref="IUIManager.RemoveModal"/>).
        /// </summary>
        ...
        /// </remarks>
        Awaitable ChangeVisibility (bool visible, float? duration = null, AsyncToken token = default);
        /// <summary>
