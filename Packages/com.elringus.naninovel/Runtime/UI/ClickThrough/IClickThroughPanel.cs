...
namespace Naninovel.UI
{
    ...
    public interface IClickThroughPanel : IManagedUI
    {
        ...
        /// <param name="allowedInputs">List of the input samplers to allow while the panel is visible.</param>
        void Show (bool hideOnClick, [CanBeNull] Action onClick, params string[] allowedInputs);
        /// <summary>
