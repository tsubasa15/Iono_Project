...
namespace Naninovel
{
    ...
    public class CameraConfiguration : Configuration
    {
        ...
        [Tooltip("Whether to disable Naninovel cameras by default when the engine is initialized. Useful when Naninovel is integrated as a drop-in dialogue system and shouldn't render after initialization.")]
        public bool DisableRendering;

        [Header("Thumbnails")]
        [Tooltip("Whether to capture small screen previews when saving the game; these previews are then used in the save slots.")]
        public bool CaptureThumbnails = true;
