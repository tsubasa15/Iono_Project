...
namespace Naninovel
{
    ...
    /// </summary>
    /// <remarks>
    /// When only <see cref="Id"/> is assigned, represents <see cref="Syntax.IdentifiedText"/>.
    /// When only <see cref="Text"/> is assigned, represents <see cref="Syntax.PlainText"/>.
    /// When only <see cref="Expression"/> is assigned, represents <see cref="Syntax.Expression"/>.
    ...
    {
        /// <summary>
        /// When represents <see cref="Syntax.IdentifiedText"/>, contains identifier of the text.
        /// </summary>
        public string Id => Kind != ParameterValuePartKind.IdentifiedText ? throw new Error("Wrong value kind.") : id;
        /// <summary>
        /// When represents <see cref="Syntax.PlainText"/> contains plain text.
        /// </summary>
        public string Text => Kind != ParameterValuePartKind.PlainText ? throw new Error("Wrong value kind.") : text;
        /// <summary>
        /// When represents <see cref="Syntax.Expression"/> contains expression body (w/o curly braces).
        /// </summary>
        ...
        public override string ToString ()
        {
            if (Kind == ParameterValuePartKind.IdentifiedText)
                return $"{Symbols.Canon.TextIdOpen}{id}{Symbols.Canon.TextIdClose}";
            if (Kind == ParameterValuePartKind.Expression)
                return $"{Symbols.Canon.ExpressionOpen}{expression}{Symbols.Canon.ExpressionClose}";
            return text;
        }
