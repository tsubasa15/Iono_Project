...
namespace Naninovel
{
    ...
    public class PlayedScriptRegister
    {
        ...
        public PlayedScriptRegister ([CanBeNull] PlayedScriptRegister other = null)
        {
            if (other != null) OverwriteFrom(other);
        }

        public void OverwriteFrom (PlayedScriptRegister other)
        {
            playedScripts = other.playedScripts;
        }
