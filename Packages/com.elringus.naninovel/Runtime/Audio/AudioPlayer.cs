...
namespace Naninovel
{
    public class AudioPlayer : IAudioPlayer, IDisposable
    {
        ...
        public Awaitable Play (AudioClip clip, float fadeInTime, AudioSource audioSource = null,
        ...
        public Awaitable Stop (AudioClip clip, float fadeOutTime, AsyncToken token = default)
        {
            return controller.StopClip(clip, fadeOutTime, token);
        }

        public Awaitable StopAll (float fadeOutTime, AsyncToken token = default)
        {
        ...
        {
            controller.CollectTracksWithClip(clip, tracks);
        }
    }
}
