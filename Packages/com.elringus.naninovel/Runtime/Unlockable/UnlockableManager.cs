...
namespace Naninovel
{
    ...
    public class UnlockableManager : IUnlockableManager, IStatefulService<GlobalStateMap>
    {
        ...
        public virtual async Awaitable InitializeService ()
        {
            ...
            LocateUnlockableResources(paths);
