...
namespace Naninovel
{
    ...
    {
        [Tooltip("Path prefix to add for each requested resource. Note that changing the default prefix can break built-in features in some cases.")]
        ...
        [Tooltip("Provider types to use, in order." +
                 ...
                 "\n • Virtual — For testing or extensibility purposes.")]
        ...
        {
            var providers = resources.CollectProviders(ProviderTypes);
