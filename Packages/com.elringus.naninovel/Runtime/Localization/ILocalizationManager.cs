...
namespace Naninovel
{
    ...
    {
        /// <summary>
        /// Occurs when the locale is changed.
        /// </summary>
        ...
        /// </summary>
        Awaitable SelectLocale (string locale);
        /// <summary>
        /// Adds an async delegate to invoke after changing a locale.
        /// </summary>
        void AddChangeLocaleTask (Func<LocaleChangedArgs, Awaitable> handler, int priority = 0);
        /// <summary>
        /// Removes an async delegate to invoke after changing a locale.
        /// </summary>
        void RemoveChangeLocaleTask (Func<LocaleChangedArgs, Awaitable> handler);
    }
}
