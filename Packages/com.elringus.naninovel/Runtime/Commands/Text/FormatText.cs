...
Lorem ipsum sit amet. <b>Consectetur adipiscing elit.</b>"
    ...
    [Serializable, Alias("format"), TextGroup, Icon("TextHeightDuo")]
    public class FormatText : PrinterCommand
    {
        ...
        [Alias(NamelessParameterAlias), RequiredParameter, ActorContext(CharactersConfiguration.DefaultPathPrefix, 1)]
        ...
        {
            return Templates.Length == 1 && Templates[0].Value.Name.EqualsIgnoreCase("default");
        }

        protected virtual void ResetTemplates (ITextPrinterActor printer)
        {
            printer.ClearTemplates();
        }

        protected virtual void AssignTemplates (ITextPrinterActor printer)
        {
