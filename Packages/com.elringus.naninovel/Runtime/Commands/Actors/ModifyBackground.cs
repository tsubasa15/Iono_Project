...
@back id:* tint:#ffdc22"
    ...
    [Serializable, Alias("back"), ActorsGroup, Icon("Image")]
    ...
    {
        [Doc("Appearance (or [pose](/guide/backgrounds#poses)) to set for the modified background and type of a [transition effect](/guide/special-effects#transition-effects) to use. " +
             "When transition is not specified, a cross-fade effect will be used by default.")]
        [Alias(NamelessParameterAlias), AppearanceContext(0, actorId: BackgroundsConfiguration.MainActorId), ConstantContext(typeof(TransitionType), 1)]
