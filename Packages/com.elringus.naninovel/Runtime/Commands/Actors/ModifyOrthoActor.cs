...
namespace Naninovel.Commands
{
        ...
        where TManager : class, IActorManager<TActor, TState, TMeta, TConfig>
    {
        ...
        protected override float?[] AssignedPosition => ResolveScenePosition();
        // Allows using scale=x for uniform scaling.
        protected override float?[] AssignedScale => Assigned(Scale) ? ResolveUniformScale() : base.AssignedScale;
        ...
        protected virtual float?[] ResolveScenePosition ()
        {
        ...
        protected virtual float?[] ResolveUniformScale ()
        {
