...
@blur Kohaku power:0 time:3.1"
    ...
    [Serializable, Alias("blur"), VisualsGroup, Icon("EyeLowVisionDuo")]
    public class SpawnBlur : SpawnEffect
    {
        ...
        [Alias(NamelessParameterAlias), ActorContext, ParameterDefaultValue(BackgroundsConfiguration.MainActorId)]
