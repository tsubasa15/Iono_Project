...
namespace Naninovel
{
    ...
    {
        /// <summary>
        /// Occurs when a print text operation is started.
        /// </summary>
        event Action<PrintMessageArgs> OnPrintStarted;
        /// <summary>
        /// Occurs when a print text operation is finished.
        /// </summary>
        ...
        Awaitable Print (string printerId, PrintedMessage message, bool append = false, float speed = 1, AsyncToken token = default);
    }
}
