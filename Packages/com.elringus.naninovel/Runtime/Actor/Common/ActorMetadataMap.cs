...
namespace Naninovel
{
    ...
    public abstract class ActorMetadataMap
    {
        ...
        [CanBeNull] public abstract ActorMetadata GetMetadata (string id);
        [CanBeNull] public abstract ActorMetadata GetMetadataWithGuid (string guid);
        public abstract void CollectIds (ICollection<string> ids);
        ...
        public IDisposable RentIds (out HashSet<string> ids)
        {
            var rent = SetPool<string>.Rent(out ids);
            CollectIds(ids);
            return rent;
        }
    }
        ...
        where TMeta : ActorMetadata
    {
        ...
        [CanBeNull] public TMeta this [string id] { get => GetMetaById(id); set => AddRecord(id, value); }
        ...
        public override ActorMetadata GetMetadataWithGuid (string guid) => GetMetaByGuid(guid);

        public override void CollectIds (ICollection<string> ids)
        {
        ...
        [CanBeNull]
        public TMeta GetMetaByGuid (string guid)
        {
            return metas.FirstOrDefault(m => m.Guid == guid);
        }
