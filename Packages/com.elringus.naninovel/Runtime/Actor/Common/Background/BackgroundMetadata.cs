...
namespace Naninovel
{
    ...
    public class BackgroundMetadata : OrthoActorMetadata
    {
        ...
        {
            public Pose () { }
            public Pose (string name, BackgroundState actorState, params string[] overriddenProperties)
        ...
        {
            Implementation = typeof(PlaceholderBackground).AssemblyQualifiedName;
