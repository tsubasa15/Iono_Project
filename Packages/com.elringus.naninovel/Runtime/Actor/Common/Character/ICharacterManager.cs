...
namespace Naninovel
{
    ...
    public interface ICharacterManager : IActorManager<ICharacterActor, CharacterState, CharacterMetadata, CharactersConfiguration>
    {
        ...
        /// <summary>
        /// Un-assigns (hides) avatar texture from a character with the specified ID.
        /// </summary>
        ...
        Awaitable ArrangeCharacters (bool lookAtOrigin, Tween tween, AsyncToken token = default);
    }
}
