...
namespace Naninovel
{
    ...
    public class ChoiceHandlersConfiguration : ActorManagerConfiguration<ChoiceHandlerMetadata>
    {
        ...
        public const string DefaultButtonPathPrefix = "ChoiceButtons";
        ...
        public ResourceLoaderConfiguration ChoiceButtonLoader = new() { PathPrefix = DefaultButtonPathPrefix };
        ...
        public ChoiceHandlersConfiguration ()
        {
