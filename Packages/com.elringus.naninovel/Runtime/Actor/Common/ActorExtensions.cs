...
namespace Naninovel
{
    ...
    public static class ActorExtensions
    {
        ...
        /// </summary>
        public static async Awaitable ChangePositionX (this IActor actor, float posX, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangePositionY (this IActor actor, float posY, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangePositionZ (this IActor actor, float posZ, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangeRotationX (this IActor actor, float rotX, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangeRotationY (this IActor actor, float rotY, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangeRotationZ (this IActor actor, float rotZ, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangeScaleX (this IActor actor, float scaleX, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangeScaleY (this IActor actor, float scaleY, Tween tween, AsyncToken token = default)
        ...
        /// </summary>
        public static async Awaitable ChangeScaleZ (this IActor actor, float scaleZ, Tween tween, AsyncToken token = default)
