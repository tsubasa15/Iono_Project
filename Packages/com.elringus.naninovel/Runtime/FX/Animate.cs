...
namespace Naninovel.FX
{
    ...
    public class Animate : MonoBehaviour, Spawn.IParameterized, Spawn.IAwaitable
    {
        ...
        protected virtual async Awaitable AnimateKey (IActor actor, int keyIndex, AsyncToken token)
        {
        ...
        protected virtual async Awaitable LoopRoutine (IActor actor, AsyncToken token)
        {
