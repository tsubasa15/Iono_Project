...
namespace Naninovel.FX
{
    ...
    public class Snow : MonoBehaviour, Spawn.IParameterized, Spawn.IAwaitable, DestroySpawned.IParameterized, DestroySpawned.IAwaitable
    {
        ...
        public Awaitable AwaitSpawn (AsyncToken token = default)
        {
            ...
            var tw = new FloatTween(emissionModule.rateOverTimeMultiplier,
                Intensity, new(time), SetRateOverTime);
        ...
        public Awaitable AwaitDestroy (AsyncToken token = default)
        {
            ...
            var tw = new FloatTween(tintColor.a, 0, new(time), SetTintOpacity);
            return intensityTweener.Run(tw, token, particles);
        }
