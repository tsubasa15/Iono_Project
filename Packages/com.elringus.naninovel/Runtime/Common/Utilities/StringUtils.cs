...
namespace Naninovel
{
    ...
    public static class StringUtils
    {
        ...
        /// </summary>
        public static bool EqualsOrdinal (this string content, string comparedString)
        {
            return string.Equals(content, comparedString, StringComparison.Ordinal);
        }

        /// <summary>
        /// Performs <see cref="string.Equals(string, string, StringComparison)"/> with <see cref="StringComparison.OrdinalIgnoreCase"/>.
        /// </summary>
        public static bool EqualsIgnoreCase (this string content, string comparedString)
        {
            return string.Equals(content, comparedString, StringComparison.OrdinalIgnoreCase);
        }

        /// <summary>
        /// Performs <see cref="string.EndsWith(string, StringComparison)"/> with <see cref="StringComparison.Ordinal"/>.
        /// </summary>
        public static bool EndsWithOrdinal (this string content, string match)
        {
        ...
        /// </summary>
        public static bool StartsWithOrdinal (this string content, string match)
        {
        ...
        {
            if (!source.EndsWithOrdinal(value))
                return source;
        ...
        public static async Awaitable<byte[]> ZipStringAsync (string content)
        {
        ...
        public static async Awaitable<string> UnzipStringAsync (byte[] content)
        {
            if (Application.platform == RuntimePlatform.WebGLPlayer)
        ...
        /// </summary>
        public static string BuildAssetLink (string path, int? lineIndex = null)
        {
            var lineRef = $" line=\"{lineIndex ?? 0}\"";
            var name = path + (lineIndex.HasValue ? $":{lineIndex.Value + 1}" : "");
