...
namespace Naninovel
{
    public static class CryptoUtils
    {
        ...
        /// <summary>
        /// Generates a hash code for the specified <see cref="string"/>;
        /// this hash code is guaranteed not to change in the future.
        /// </summary>
        ...
        /// <summary>
        /// Generates a hash code in hex format for the specified <see cref="string"/>;
        /// the hash code is guaranteed not to change in the future.
        /// </summary>
