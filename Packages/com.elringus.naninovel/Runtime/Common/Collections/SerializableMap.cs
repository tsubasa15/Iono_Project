...
namespace Naninovel
{
    public abstract class SerializableMap
    {
        protected class Dictionary<TKey, TValue> : System.Collections.Generic.Dictionary<TKey, TValue>
        {
            ...
            public Dictionary (IReadOnlyDictionary<TKey, TValue> dict) : base(dict) { }
            public Dictionary (IReadOnlyDictionary<TKey, TValue> dict, IEqualityComparer<TKey> comparer) : base(dict, comparer) { }
        ...
        ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
    {
        ...
        protected SerializableMap (IReadOnlyDictionary<TKey, TValue> dict)
        {
            dictionary = new(dict);
        }

        protected SerializableMap (IReadOnlyDictionary<TKey, TValue> dict, IEqualityComparer<TKey> comparer)
        {
