...
namespace Naninovel
{
    public class ActorRecordAssetProcessor : AssetModificationProcessor
    {
        private static AssetDeleteResult OnWillDeleteAsset (string assetPath, RemoveAssetOptions options)
        {
            ...
            RemoveActorRecord(record.ActorId, metadata);
            RemoveAssociatedAssets(metadata);
        ...
        private static void RemoveAssociatedAssets (ActorMetadata metadata)
        {
            var group = metadata.GetResourceGroup();
