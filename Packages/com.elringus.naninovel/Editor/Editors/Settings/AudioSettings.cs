...
namespace Naninovel
{
    public class AudioSettings : ResourcefulSettings<AudioConfiguration>
    {
        ...
        protected override string ResourcesPrefix => Configuration.AudioLoader.PathPrefix;
        ...
        protected override void DrawConfigurationEditor ()
        {
            ...
            if (Configuration.EnableAutoVoicing && !ShowResourcesEditor &&
                GUILayout.Button("Open Voice Map Utility", GUIStyles.NavigationButton))
        ...
        [MenuItem(MenuPath.Root + "/Resources/Audio")]
