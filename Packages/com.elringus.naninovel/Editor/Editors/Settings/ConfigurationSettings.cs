    ...
    public class ConfigurationSettings : SettingsProvider
    {
            ...
            where TConfig : Configuration, new()
        {
            ...
            if (!AssetDatabase.Contains(configuration))
                CreateConfigurationAsset(configuration);
        ...
        private static void CreateConfigurationAsset (Configuration configuration)
        {
        ...
        [MenuItem(MenuPath.Root + "/Configuration", priority = 1)]
