...
namespace Naninovel
{
    public class FountainWindow : EditorWindow
    {
        ...
        [MenuItem(MenuPath.Root + "/Tools/Fountain Screenplay")]
        public static void OpenWindow ()
        {
            GetWindow<FountainWindow>("Fountain Screenplay");
        }

        private void OnGUI ()
        {
            using var _ = EditorUtils.ScrollView(nameof(FountainWindow));

            EditorGUILayout.LabelField("Fountain Screenplay Converter", EditorStyles.boldLabel);
            EditorGUILayout.LabelField("The tool to convert .fountain to .nani; see `Fountain` guide for usage instructions.", EditorStyles.wordWrappedMiniLabel);
