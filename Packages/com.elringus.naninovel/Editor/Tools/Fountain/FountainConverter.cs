    ...
    public class FountainConverter
    {
        ...
        private void ProcessSection (FountainSplitter.Section section)
        {
            foreach (var line in section.Text.IterateLines())
                ProcessLine(line);
            var scriptText = Compiler.SyntaxFormatter.Format(lines);
        ...
        private void ProcessLine (string line)
        {
            ...
            else if (ShouldAddComment(line)) lines.Add(new Syntax.CommentLine(line));
        }
        ...
        private static Syntax.GenericLine BuildAuthoredLine (string character, string text)
        {
        ...
        private static Syntax.GenericLine BuildGenericLine (string text)
        {
        ...
        private bool IsCharacter (string line)
        {
            ...
            if (trimmed.StartsWithOrdinal("@")) return true;
        ...
        private bool IsAction (string line)
        {
            ...
            return char.IsLetterOrDigit(trimmed.FirstOrDefault()) &&
                   !trimmed.StartsWithOrdinal("INT ") &&
                   !trimmed.StartsWithOrdinal("INT.") &&
                   !trimmed.StartsWithOrdinal("EXT ") &&
                   !trimmed.StartsWithOrdinal("EXT.") &&
                   !trimmed.StartsWithOrdinal("EST ") &&
                   !trimmed.StartsWithOrdinal("EST.") &&
                   !trimmed.StartsWithOrdinal("INT./EXT ") &&
                   !trimmed.StartsWithOrdinal("INT./EXT.") &&
                   !trimmed.StartsWithOrdinal("INT/EXT ") &&
                   !trimmed.StartsWithOrdinal("INT/EXT.") &&
                   !trimmed.StartsWithOrdinal("I/E ") &&
                   !trimmed.StartsWithOrdinal("I/E.") &&
                   !trimmed.StartsWithOrdinal("INT ") &&
                   !trimmed.StartsWithOrdinal("INT.") &&
                   !trimmed.EndsWithOrdinal("TO:");
        }
    }
}
