Shader "Naninovel/TransitionalUI"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float4 mainColor = (tex2D(_MainTex, vertexOutput.MainTexCoord) + _TextureSampleAdd) * vertexOutput.Color;
                ...
                float4 transitionColor = (tex2D(_TransitionTex, vertexOutput.MainTexCoord/*TransitionTexCoord*/) + _TextureSampleAdd) * vertexOutput.Color;

                float4 color = lerp(mainColor, transitionColor, _TransitionProgress);
