Shader "Naninovel/TransitionalTexture"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            UNITY_DECLARE_TEX2D(_TransitionTex);
            UNITY_DECLARE_TEX2D(_CloudsTex);
            UNITY_DECLARE_TEX2D(_DissolveTex);
            ...
            {
                float4 color = ApplyTransitionEffect(
                    vertexOutput.MainTexCoord, vertexOutput.TransitionTexCoord,
                    _TransitionProgress, _TransitionParams, _RandomSeed);
